...
module attributes {transform.with_named_sequence} {
  ...
  util.func private @conv_entry_point_k1(%arg0: tensor<2x34x34x1280xf16>, %arg1: tensor<3x3x1280x1280xf16>) 
    ...
    %4 = tensor.empty() : tensor<1280x3x3x1280xf16>
    %wei_tr = linalg.transpose ins(%arg1: tensor<3x3x1280x1280xf16>) outs(%4 : tensor<1280x3x3x1280xf16>) permutation = [3, 0, 1, 2] 
    ...
    %magic_4 = arith.constant 32 : i32
    %magic_5 = arith.constant 0 : i32
    %shift_pack_0 = arith.constant 117770755 : i32
    %shift_pack_1 = arith.constant 0 : i32
    %ks = arith.constant 3 : i32
    %pack_0 = arith.constant 0 : i32
  ...
  transform.named_sequence @match_conv_k1(
    ...
    %ins, %outs = transform.iree.match.cast_compatible_dag_from_root %root {
      ^bb0(%lhs: tensor<2x34x34x1280xf16>, %rhs: tensor<3x3x1280x1280xf16>):
        %2 = tensor.empty() : tensor<2x32x32x1280xf16>
        %6 = linalg.conv_2d_nhwc_hwcf {dilations = dense<1> : vector<2xi64>, strides = dense<1> : vector<2xi64>} ins(%lhs, %rhs : tensor<2x34x34x1280xf16>, tensor<3x3x1280x1280xf16>) outs(%2 : tensor<2x32x32x1280xf16>) -> tensor<2x32x32x1280xf16>
    ...
    util.func private @conv_entry_point_k2(%arg0: tensor<2x34x34x1280xf16>, %arg1: tensor<3x3x1280x2560xf16>) 
                                          -> tensor<2x32x32x2560xf16> {
    %4 = tensor.empty() : tensor<2560x3x3x1280xf16>
    %wei_tr = linalg.transpose ins(%arg1: tensor<3x3x1280x2560xf16>) outs(%4 : tensor<2560x3x3x1280xf16>) permutation = [3, 0, 1, 2] 
    %hi = arith.constant 34 : i32
    %wi = arith.constant 34 : i32
    %n = arith.constant 2 : i32
    %c = arith.constant 1280 : i32
    ...
    %magic_2 = arith.constant 1 : i32
    %magic_3 = arith.constant 2576980378 : i32
    %magic_4 = arith.constant 61853 : i32
    %magic_5 = arith.constant 17353 : i32
    %shift_pack_0 = arith.constant 134547973 : i32
    %shift_pack_1 = arith.constant 45007 : i32
    %ks = arith.constant 3 : i32
    %pack_0 = arith.constant 0 : i32
    ...
    %5 = hal.dispatch.extern "igemm_fwd_gtcx3_nhwc_fp16_bx0_ex1_bt256x128x32_wt32x32x8_ws2x1_wr2x2_ta1x8x4x1_1x4x1x64_tb1x8x2x1_1x4x1x64_gkgs"(%hi, %wi, %n,
      ...
      attributes {subgroupSize = 64, workgroup_size = [256 : index, 1 : index, 1 : index]}
    util.return %5 : tensor<2x32x32x2560xf16>
  }
  ...
  transform.named_sequence @match_conv_k2(
    ...
    %ins, %outs = transform.iree.match.cast_compatible_dag_from_root %root {
      ^bb0(%lhs: tensor<2x34x34x1280xf16>, %rhs: tensor<3x3x1280x2560xf16>):
        %2 = tensor.empty() : tensor<2x32x32x2560xf16>
        %6 = linalg.conv_2d_nhwc_hwcf {dilations = dense<1> : vector<2xi64>, strides = dense<1> : vector<2xi64>} ins(%lhs, %rhs : tensor<2x34x34x1280xf16>, tensor<3x3x1280x2560xf16>) outs(%2 : tensor<2x32x32x2560xf16>) -> tensor<2x32x32x2560xf16>
      } : (!transform.any_op) -> (!transform.any_value, !transform.any_value)
    transform.yield %ins, %outs : !transform.any_value, !transform.any_value
  }
  ...
  util.func private @conv_entry_point_k5(%arg0: tensor<2x66x66x1280xf16>, %arg1: tensor<3x3x1280x1280xf16>) 
    ...
    %5 = hal.dispatch.extern "igemm_fwd_gtcx3_nhwc_fp16_bx0_ex1_bt256x128x32_wt32x32x8_ws2x1_wr2x2_ta1x8x4x1_1x4x1x64_tb1x8x2x1_1x4x1x64_gkgs"(%arg0, %wei_tr, 
